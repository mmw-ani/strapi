"use strict";(self.webpackChunkbackend=self.webpackChunkbackend||[]).push([[5905],{57134:(oe,O,n)=>{n.r(O),n.d(O,{default:()=>lt});var e=n(67294),r=n(87631),$=n(96315),W=n(85018),K=n(4585),X=n(67109),D=n(53979),m=n(11047),R=n(29728),L=n(49066),g=n(41580),V=n(27361),l=n.n(V),f=n(18721),x=n.n(f),b=n(18446),C=n.n(b),k=n(11700),N=n.n(k),I=n(86896),J=n(16550),q=n(45697),o=n.n(q),ge=n(38939),fe=n(8060),he=n(79031),_=n(37909),T=n(75515),ke=n(49386),ye=n(26478),H=n(13588),Z=n(71997),v=n(5002),je=n(70968),Be=n(52624),Ee=n(44915);function ae({isActive:t,icon:a}){return e.createElement(m.k,{alignItems:"center",background:t?"primary200":"neutral200",justifyContent:"center",height:8,width:8,borderRadius:"50%"},e.createElement(Be.J,{as:Ee.c[a]||Ee.c.cube,height:5,width:5}))}ae.defaultProps={isActive:!1,icon:"Cube"},ae.propTypes={isActive:o().bool,icon:o().string};const be=(0,Z.ZP)(g.x)`
  position: absolute;
  display: none;
  top: 5px;
  right: ${(0,r.Q1)(8)};
